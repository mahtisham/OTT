<div class="admin-table-action-block">
  @can('menu.edit')
    <a href="{{route('menu.edit', $id)}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
  @endcan
  @can('menu.delete')
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="POST" action="{{route("menu.destroy", $id)}}">
          @method("DELETE")
          @csrf                          
