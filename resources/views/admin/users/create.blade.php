        ...
        <div class="admin-form-block z-depth-1">          
          {!! Form::open(['method' => 'POST', 'action' => 'UsersController@store', 'files' => true]) !!}
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              {!! Form::text('name', null, ['class' => 'form-control', 'required' => 'required', 'autofocus', 'placeholder' => __('Please Enter Your Name') ]) !!}
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
              ...
              {!! Form::email('email', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Please Enter Your Email')]) !!}
            ...
            <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
              ...
              {!! Form::number('mobile', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('enter your mobile no')]) !!}
            ...
            <div class="search form-group{{ $errors->has('password') ? ' has-error' : '' }}">
              ...
              {!! Form::password('password', ['id' => 'password',' class' => 'form-control', 'required' => 'required', 'placeholder' => __('Please Enter Your Password')]) !!}
            ...
            <div class="search form-group{{ $errors->has('confirm_password') ? ' has-error' : '' }}">
              ...
              <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="{{__('Please Enter Your Password Again')}}"></i>
              {!! Form::password('confirm_password', ['id' => 'confirm_password','class' => 'form-control', 'required' => 'required', 'placeholder' =>__('Please Enter Your Password Again')]) !!}
