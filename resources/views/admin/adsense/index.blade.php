          ...
          <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
              ...
              <div class="row">
                ...
                <div class="col-md-5 pad-0">
                  <div class="make-switch">
                    {!! Form::checkbox('status', 1, ($ad->status == '1' ? true : false), ['class' => 'bootswitch', "data-on-text"=>__('Active'), "data-off-text"=>__('Inactive'), "data-size"=>"small"]) !!}
                  </div>
                </div>
              </div>
              <div class="col-md-12">
            ...
            <!-- is Home -->
              ...
              <div class="row">
                ...
                <div class="col-md-5 pad-0">
                  <div class="make-switch">
                    {!! Form::checkbox('ishome', 1, ($ad->ishome == '1' ? true : false), ['class' => 'bootswitch', "data-on-text"=>__('Active'), "data-off-text"=>__('In Active'), "data-size"=>"small"]) !!}
                  </div>
                </div>
              </div>
              <div class="col-md-12">
            ...
            <!-- is wishlist -->
              ...
              <div class="row">
                ...
                <div class="col-md-5 pad-0">
                  <div class="make-switch">
                    {!! Form::checkbox('iswishlist', 1, ($ad->iswishlist == '1' ? true : false), ['class' => 'bootswitch', "data-on-text"=>__('Active'), "data-off-text"=>__('In Active'), "data-size"=>"small"]) !!}
                  </div>
                </div>
              </div>
              <div class="col-md-12">
            ...
            <!-- is View All -->
              ...
              <div class="row">
                ...
                <div class="col-md-5 pad-0">
                  <div class="make-switch">
                    {!! Form::checkbox('isviewall', 1, ($ad->isviewall == '1' ? true : false), ['class' => 'bootswitch', "data-on-text"=>__('Active'), "data-off-text"=>__('In Active'), "data-size"=>"small"]) !!}
                  </div>
                </div>
              </div>
              <div class="col-md-12">
