<div class="admin-table-action-block">
  @can('package-feature.edit')
    <a href="{{route('package_feature.edit', $id)}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
  @endcan
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="POST" action="{{route("package_feature.destroy", $id)}}">
          @method("DELETE")
          @csrf                          
