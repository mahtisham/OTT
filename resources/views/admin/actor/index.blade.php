...
<div class="content-main-block mrg-t-40">
  <div class="admin-create-btn-block">
    ...
    <a data-toggle="modal" data-target="#importactor" role="button" class="btn btn-danger btn-md"><i class="material-icons left">description</i> {{__('Import Actors')}}</a>
      <a href="{{route('actors.create')}}" class="btn btn-danger btn-md"><i class="material-icons left">add</i> {{__('Create Actor')}}</a>
    @endcan
    <!-- Delete Modal -->
    @can('actor.delete')
    ...
    <div class="modal fade" id="importactor" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- main content start -->
            <a href="{{ url('files/Actors.xlsx') }}" class="btn btn-md btn-success pull-right"> {{__('Download Example xls/csv
              File')}}</a>
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><b>{{__('No')}}</b></td>
                      <td>{{__('Enter actors biography')}}</b></td>
                    </tr>
            ...
            <div class="card-two card">
              ...
              <div class="dropdown card-dropdown">
                ...
                <div class="dropdown-menu pull-right" aria-labelledby="dropdownMenuButton-{{$item->id}}">
                  @can('actor.view')
                    <a class="dropdown-item" href="{{url('video/detail/actor_search', $item->slug)}}" target="__blank"><i class="material-icons">desktop_mac</i> {{__('Page Preview')}}</a>
                  @endcan
                  
                  @can('actor.edit')
                    <a class="dropdown-item" href="{{ route('actors.edit', $item->id)}}"><i class="material-icons">mode_edit</i> {{__('Edit')}}</a>
                  @endcan
              ...
              <div class="card-body">
                ...
                {{-- <div class="card-block">
                  ...
                  <div class="card-icons">
                    <ul>
                      <li>
                          <a href="{{url('video/detail/actor_search', $item->slug)}}" target="__blank" data-toggle="tooltip" data-original-title="Page Preview" class="btn-default btn-floating"><i class="material-icons">desktop_mac</i></a>
                        </li>
                      @can('actor.edit')
                      <li>
