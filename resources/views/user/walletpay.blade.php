      ...
      <div class="mt-2 shadow-sm card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
              <form method="POST" action="{{ route('wallet.add.using.stripe') }}" id="credit-card" class="StripeCard">
                @csrf
                
                <div class="form-group">
                  <input class="form-control" placeholder="{{__('Card number')}}" type="tel" name="number">
                ...
                <div class="form-group">
                  <input class="form-control" placeholder="{{__('CVC')}}" type="password" name="cvc">
                  @if ($errors->has('cvc'))
                    <span class="invalid-feedback" role="alert">
