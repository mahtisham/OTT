...
<section class="invoice">
  ...
  <div class="row">
    ...
    <div class="col-xs-6">
      ...
      {{__('Etsy doostang zoodles disqus groupon greplin oooj voxy zoodles, weebly ning heekya handango imeem plugg
    ...
    <div class="col-xs-6">
      <div class="table-responsive">
        <h2 style="margin-top: 100px"> {{__('Total Amount')}}: {{strtoupper($currency_code)}} {{$invoice->lines->data[0]->plan->amount/100}}</h2>
      </div>
    </div>
    <!-- /.col -->
  </div>
...
<section class="invoice">
  ...
  <div class="row invoice-info">
    ...
    <!-- /.col -->
    <div class="col-sm-4 invoice-col">
      <b>{{__('Invoice')}} #{{$paypal_sub->id}}</b><br>
      <br>
      <b>{{__('Order ID')}}:</b> {{$paypal_sub->payment_id}}<br>
    </div>
    <!-- /.col -->
  </div>
  <!-- /.row -->
  ...
  <div class="row">
    ...
    <div class="col-xs-6">
      <div class="table-responsive">
        <h2 style="margin-top: 100px"> {{__('Total Amount')}}: {{strtoupper($currency_code)}} {{$paypal_sub->price}}</h2>
      </div>
    </div>
    <!-- /.col -->
  </div>
